...
DynaTech CraftNwsia adalah dynatechtranslatedd fork dari slimefunguguproject

**Dyna Tech support java 21+ dan mc 1.21.11**

## 下载

[![Chinese Versiom](https://builds.guizhanss.com/api/badge/SlimefunGuguProject/DynaTech/master/latest)](https://builds.guizhanss.com/SlimefunGuguProject/DynaTech)

## 机器

disini masih beta dan masi banyak bug kayaknya
rencana saya akan menambahkan tools baru dari dynatech
